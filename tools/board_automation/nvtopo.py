...
class nv_topo_target:
    ...
    def target_power_off(self):
        ...
        print("Powering off the board. This process may take about 12 seconds. Please do not interrupt the process!")
    ...
    def __init__(self, target= 'topo', serial_number=None, index=None):
        ...
        if serial_number is None:
            ...
            for i in range(self.dev_cnt):
                ...
                if di.serial_number == serial_number:
